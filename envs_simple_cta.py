...
class SimpleEvaluator(WtEvaluator):
    env_name = 'simple-cta-evaluator-v0'
...
register(id='simple-cta-trainer-v0', entry_point=SimpleTrainer)
register(id='simple-cta-evaluator-v0', entry_point=SimpleEvaluator)
